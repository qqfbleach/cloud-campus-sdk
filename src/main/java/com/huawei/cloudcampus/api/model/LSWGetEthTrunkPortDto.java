...
public class LSWGetEthTrunkPortDto {
  ...
  public LSWGetEthTrunkPortDto status(Boolean status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto description(String description) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto linkType(String linkType) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto defaultVlan(Integer defaultVlan) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto allowPassVlan(String allowPassVlan) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto dhcpSnooping(Boolean dhcpSnooping) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto dhcpSnoopingTrusted(Boolean dhcpSnoopingTrusted) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto ndSnooping(Boolean ndSnooping) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto ndSnoopingTrusted(Boolean ndSnoopingTrusted) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto portIsolation(Boolean portIsolation) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto stp(Boolean stp) {
    this.stp = stp;
    return this;
  }
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto stpEdgedport(String stpEdgedport) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto enableRelay(Boolean enableRelay) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto enableMadDetection(Boolean enableMadDetection) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto domainId(Integer domainId) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto naMsgCheck(Boolean naMsgCheck) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto nsMsgCheck(Boolean nsMsgCheck) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto rsMsgCheck(Boolean rsMsgCheck) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto ipsgCheck(Boolean ipsgCheck) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto daiCheck(Boolean daiCheck) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto ipSubnetVlanEnable(Boolean ipSubnetVlanEnable) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto ethTrunkMode(String ethTrunkMode) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto portMemberList(List<String> portMemberList) {
    this.portMemberList = portMemberList;
    return this;
  }

  public LSWGetEthTrunkPortDto addPortMemberListItem(String portMemberListItem) {
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto name(String name) {
    this.name = name;
    return this;
  }
   ...
   * return name
  **/
  @ApiModelProperty(required = true, value = "EthTrunk端口名称，必须是Eth-Trunk[数字]的格式，数字最大63。")
  ...
  **/
  ...
  public LSWGetEthTrunkPortDto isUpStream(Boolean isUpStream) {
   ...
   * return isUpStream
  **/
  @ApiModelProperty(required = true, value = "端口是否为上行口（只读）。")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LSWGetEthTrunkPortDto lsWGetEthTrunkPortDto = (LSWGetEthTrunkPortDto) o;
    return Objects.equals(this.status, lsWGetEthTrunkPortDto.status) &&
        Objects.equals(this.description, lsWGetEthTrunkPortDto.description) &&
        Objects.equals(this.linkType, lsWGetEthTrunkPortDto.linkType) &&
        Objects.equals(this.defaultVlan, lsWGetEthTrunkPortDto.defaultVlan) &&
        Objects.equals(this.allowPassVlan, lsWGetEthTrunkPortDto.allowPassVlan) &&
        Objects.equals(this.dhcpSnooping, lsWGetEthTrunkPortDto.dhcpSnooping) &&
        Objects.equals(this.dhcpSnoopingTrusted, lsWGetEthTrunkPortDto.dhcpSnoopingTrusted) &&
        Objects.equals(this.ndSnooping, lsWGetEthTrunkPortDto.ndSnooping) &&
        Objects.equals(this.ndSnoopingTrusted, lsWGetEthTrunkPortDto.ndSnoopingTrusted) &&
        Objects.equals(this.portIsolation, lsWGetEthTrunkPortDto.portIsolation) &&
        Objects.equals(this.stp, lsWGetEthTrunkPortDto.stp) &&
        Objects.equals(this.stpEdgedport, lsWGetEthTrunkPortDto.stpEdgedport) &&
        Objects.equals(this.enableRelay, lsWGetEthTrunkPortDto.enableRelay) &&
        Objects.equals(this.enableMadDetection, lsWGetEthTrunkPortDto.enableMadDetection) &&
        Objects.equals(this.domainId, lsWGetEthTrunkPortDto.domainId) &&
        Objects.equals(this.naMsgCheck, lsWGetEthTrunkPortDto.naMsgCheck) &&
        Objects.equals(this.nsMsgCheck, lsWGetEthTrunkPortDto.nsMsgCheck) &&
        Objects.equals(this.rsMsgCheck, lsWGetEthTrunkPortDto.rsMsgCheck) &&
        Objects.equals(this.ipsgCheck, lsWGetEthTrunkPortDto.ipsgCheck) &&
        Objects.equals(this.daiCheck, lsWGetEthTrunkPortDto.daiCheck) &&
        Objects.equals(this.ipSubnetVlanEnable, lsWGetEthTrunkPortDto.ipSubnetVlanEnable) &&
        Objects.equals(this.ethTrunkMode, lsWGetEthTrunkPortDto.ethTrunkMode) &&
        Objects.equals(this.portMemberList, lsWGetEthTrunkPortDto.portMemberList) &&
        Objects.equals(this.name, lsWGetEthTrunkPortDto.name) &&
        Objects.equals(this.isUpStream, lsWGetEthTrunkPortDto.isUpStream);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, description, linkType, defaultVlan, allowPassVlan, dhcpSnooping, dhcpSnoopingTrusted, ndSnooping, ndSnoopingTrusted, portIsolation, stp, stpEdgedport, enableRelay, enableMadDetection, domainId, naMsgCheck, nsMsgCheck, rsMsgCheck, ipsgCheck, daiCheck, ipSubnetVlanEnable, ethTrunkMode, portMemberList, name, isUpStream);
  }
  ...
  public String toString() {
    ...
    sb.append("class LSWGetEthTrunkPortDto {\n");
