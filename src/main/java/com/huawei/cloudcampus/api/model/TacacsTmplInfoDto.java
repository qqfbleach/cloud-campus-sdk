...
public class TacacsTmplInfoDto {
  @SerializedName("name")
  ...
  public TacacsTmplInfoDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public TacacsTmplInfoDto description(String description) {
  ...
  **/
  ...
  public TacacsTmplInfoDto masterAuthenServerIp(String masterAuthenServerIp) {
  ...
  **/
  ...
  public TacacsTmplInfoDto masterAuthenServerPort(Integer masterAuthenServerPort) {
  ...
  **/
  ...
  public TacacsTmplInfoDto slaveAuthenServerIp(String slaveAuthenServerIp) {
  ...
  **/
  ...
  public TacacsTmplInfoDto slaveAuthenServerPort(Integer slaveAuthenServerPort) {
  ...
  **/
  ...
  public TacacsTmplInfoDto masterAuthorServerIp(String masterAuthorServerIp) {
  ...
  **/
  ...
  public TacacsTmplInfoDto masterAuthorServerPort(Integer masterAuthorServerPort) {
  ...
  **/
  ...
  public TacacsTmplInfoDto slaveAuthorServerIp(String slaveAuthorServerIp) {
  ...
  **/
  ...
  public TacacsTmplInfoDto slaveAuthorServerPort(Integer slaveAuthorServerPort) {
  ...
  **/
  ...
  public TacacsTmplInfoDto masterAccServerIp(String masterAccServerIp) {
  ...
  **/
  ...
  public TacacsTmplInfoDto masterAccServerPort(Integer masterAccServerPort) {
  ...
  **/
  ...
  public TacacsTmplInfoDto slaveAccServerIp(String slaveAccServerIp) {
  ...
  **/
  ...
  public TacacsTmplInfoDto slaveAccServerPort(Integer slaveAccServerPort) {
  ...
  **/
  ...
  public TacacsTmplInfoDto includeDomain(Boolean includeDomain) {
  ...
  **/
  ...
  public TacacsTmplInfoDto id(UUID id) {
    this.id = id;
    return this;
  }
   ...
   * return id
  **/
  @ApiModelProperty(required = true, value = "Tacacs模板ID。")
  public UUID getId() {
    return id;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TacacsTmplInfoDto tacacsTmplInfoDto = (TacacsTmplInfoDto) o;
    return Objects.equals(this.name, tacacsTmplInfoDto.name) &&
        Objects.equals(this.description, tacacsTmplInfoDto.description) &&
        Objects.equals(this.masterAuthenServerIp, tacacsTmplInfoDto.masterAuthenServerIp) &&
        Objects.equals(this.masterAuthenServerPort, tacacsTmplInfoDto.masterAuthenServerPort) &&
        Objects.equals(this.slaveAuthenServerIp, tacacsTmplInfoDto.slaveAuthenServerIp) &&
        Objects.equals(this.slaveAuthenServerPort, tacacsTmplInfoDto.slaveAuthenServerPort) &&
        Objects.equals(this.masterAuthorServerIp, tacacsTmplInfoDto.masterAuthorServerIp) &&
        Objects.equals(this.masterAuthorServerPort, tacacsTmplInfoDto.masterAuthorServerPort) &&
        Objects.equals(this.slaveAuthorServerIp, tacacsTmplInfoDto.slaveAuthorServerIp) &&
        Objects.equals(this.slaveAuthorServerPort, tacacsTmplInfoDto.slaveAuthorServerPort) &&
        Objects.equals(this.masterAccServerIp, tacacsTmplInfoDto.masterAccServerIp) &&
        Objects.equals(this.masterAccServerPort, tacacsTmplInfoDto.masterAccServerPort) &&
        Objects.equals(this.slaveAccServerIp, tacacsTmplInfoDto.slaveAccServerIp) &&
        Objects.equals(this.slaveAccServerPort, tacacsTmplInfoDto.slaveAccServerPort) &&
        Objects.equals(this.includeDomain, tacacsTmplInfoDto.includeDomain) &&
        Objects.equals(this.id, tacacsTmplInfoDto.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, masterAuthenServerIp, masterAuthenServerPort, slaveAuthenServerIp, slaveAuthenServerPort, masterAuthorServerIp, masterAuthorServerPort, slaveAuthorServerIp, slaveAuthorServerPort, masterAccServerIp, masterAccServerPort, slaveAccServerIp, slaveAccServerPort, includeDomain, id);
  }
  ...
  public String toString() {
    ...
    sb.append("class TacacsTmplInfoDto {\n");
