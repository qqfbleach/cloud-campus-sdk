...
public class CreateTacacsTmplInfoDto {
  @SerializedName("name")
  ...
  public CreateTacacsTmplInfoDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto description(String description) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto masterAuthenServerIp(String masterAuthenServerIp) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto masterAuthenServerPort(Integer masterAuthenServerPort) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto slaveAuthenServerIp(String slaveAuthenServerIp) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto slaveAuthenServerPort(Integer slaveAuthenServerPort) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto masterAuthorServerIp(String masterAuthorServerIp) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto masterAuthorServerPort(Integer masterAuthorServerPort) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto slaveAuthorServerIp(String slaveAuthorServerIp) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto slaveAuthorServerPort(Integer slaveAuthorServerPort) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto masterAccServerIp(String masterAccServerIp) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto masterAccServerPort(Integer masterAccServerPort) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto slaveAccServerIp(String slaveAccServerIp) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto slaveAccServerPort(Integer slaveAccServerPort) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto includeDomain(Boolean includeDomain) {
  ...
  **/
  ...
  public CreateTacacsTmplInfoDto shareKey(String shareKey) {
   ...
   * return shareKey
  **/
  @ApiModelProperty(required = true, value = "秘钥（英文字母、数字、除空格和问号外特殊符号，建议长度为6位以上）。")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateTacacsTmplInfoDto createTacacsTmplInfoDto = (CreateTacacsTmplInfoDto) o;
    return Objects.equals(this.name, createTacacsTmplInfoDto.name) &&
        Objects.equals(this.description, createTacacsTmplInfoDto.description) &&
        Objects.equals(this.masterAuthenServerIp, createTacacsTmplInfoDto.masterAuthenServerIp) &&
        Objects.equals(this.masterAuthenServerPort, createTacacsTmplInfoDto.masterAuthenServerPort) &&
        Objects.equals(this.slaveAuthenServerIp, createTacacsTmplInfoDto.slaveAuthenServerIp) &&
        Objects.equals(this.slaveAuthenServerPort, createTacacsTmplInfoDto.slaveAuthenServerPort) &&
        Objects.equals(this.masterAuthorServerIp, createTacacsTmplInfoDto.masterAuthorServerIp) &&
        Objects.equals(this.masterAuthorServerPort, createTacacsTmplInfoDto.masterAuthorServerPort) &&
        Objects.equals(this.slaveAuthorServerIp, createTacacsTmplInfoDto.slaveAuthorServerIp) &&
        Objects.equals(this.slaveAuthorServerPort, createTacacsTmplInfoDto.slaveAuthorServerPort) &&
        Objects.equals(this.masterAccServerIp, createTacacsTmplInfoDto.masterAccServerIp) &&
        Objects.equals(this.masterAccServerPort, createTacacsTmplInfoDto.masterAccServerPort) &&
        Objects.equals(this.slaveAccServerIp, createTacacsTmplInfoDto.slaveAccServerIp) &&
        Objects.equals(this.slaveAccServerPort, createTacacsTmplInfoDto.slaveAccServerPort) &&
        Objects.equals(this.includeDomain, createTacacsTmplInfoDto.includeDomain) &&
        Objects.equals(this.shareKey, createTacacsTmplInfoDto.shareKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateTacacsTmplInfoDto {\n");
