...
public class LSWGetEthPortDto {
  ...
  @SerializedName("isSupportAutoNegotiation")
  private Boolean isSupportAutoNegotiation = null;

  @SerializedName("isSupportPoe")
  private Boolean isSupportPoe = null;

  @SerializedName("media")
  private String media = null;

  @SerializedName("isUpStream")
  private Boolean isUpStream = null;

  public LSWGetEthPortDto status(Boolean status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public LSWGetEthPortDto description(String description) {
  ...
  **/
  ...
  public LSWGetEthPortDto linkType(String linkType) {
  ...
  **/
  ...
  public LSWGetEthPortDto defaultVlan(Integer defaultVlan) {
  ...
  **/
  ...
  public LSWGetEthPortDto allowPassVlan(String allowPassVlan) {
  ...
  **/
  ...
  public LSWGetEthPortDto dhcpSnooping(Boolean dhcpSnooping) {
  ...
  **/
  ...
  public LSWGetEthPortDto dhcpSnoopingTrusted(Boolean dhcpSnoopingTrusted) {
  ...
  **/
  ...
  public LSWGetEthPortDto ndSnooping(Boolean ndSnooping) {
  ...
  **/
  ...
  public LSWGetEthPortDto ndSnoopingTrusted(Boolean ndSnoopingTrusted) {
  ...
  **/
  ...
  public LSWGetEthPortDto portIsolation(Boolean portIsolation) {
  ...
  **/
  ...
  public LSWGetEthPortDto stp(Boolean stp) {
    this.stp = stp;
    return this;
  }
  ...
  **/
  ...
  public LSWGetEthPortDto stpEdgedport(String stpEdgedport) {
  ...
  **/
  ...
  public LSWGetEthPortDto enableRelay(Boolean enableRelay) {
  ...
  **/
  ...
  public LSWGetEthPortDto enableMadDetection(Boolean enableMadDetection) {
  ...
  **/
  ...
  public LSWGetEthPortDto domainId(Integer domainId) {
  ...
  **/
  ...
  public LSWGetEthPortDto naMsgCheck(Boolean naMsgCheck) {
  ...
  **/
  ...
  public LSWGetEthPortDto nsMsgCheck(Boolean nsMsgCheck) {
  ...
  **/
  ...
  public LSWGetEthPortDto rsMsgCheck(Boolean rsMsgCheck) {
  ...
  **/
  ...
  public LSWGetEthPortDto ipsgCheck(Boolean ipsgCheck) {
  ...
  **/
  ...
  public LSWGetEthPortDto daiCheck(Boolean daiCheck) {
  ...
  **/
  ...
  public LSWGetEthPortDto ipSubnetVlanEnable(Boolean ipSubnetVlanEnable) {
  ...
  **/
  ...
  public LSWGetEthPortDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public LSWGetEthPortDto autoNegotiationEnable(Boolean autoNegotiationEnable) {
  ...
  **/
  ...
  public LSWGetEthPortDto speed(String speed) {
    this.speed = speed;
    return this;
  }
  ...
  **/
  ...
  public LSWGetEthPortDto duplex(String duplex) {
    this.duplex = duplex;
    return this;
  }
  ...
  **/
  ...
  public LSWGetEthPortDto stormControl(Boolean stormControl) {
  ...
  **/
  ...
  public LSWGetEthPortDto stormControlModel(String stormControlModel) {
  ...
  **/
  ...
  public LSWGetEthPortDto stormControlMaxRate(Integer stormControlMaxRate) {
  ...
  **/
  ...
  public LSWGetEthPortDto stormControlMinRate(Integer stormControlMinRate) {
  ...
  **/
  ...
  public LSWGetEthPortDto stormControlInterval(Integer stormControlInterval) {
  ...
  **/
  ...
  public LSWGetEthPortDto poe(Boolean poe) {
    this.poe = poe;
    return this;
  }
  ...
  **/
  ...
  public LSWGetEthPortDto lldp(Boolean lldp) {
    this.lldp = lldp;
    return this;
  }
  ...
  **/
  ...
  public LSWGetEthPortDto cdp(Boolean cdp) {
    this.cdp = cdp;
    return this;
  }
  ...
  **/
  ...
  public LSWGetEthPortDto loopbackDetectEnabled(Boolean loopbackDetectEnabled) {
  ...
  **/
  ...
  public LSWGetEthPortDto loopbackDetectAction(String loopbackDetectAction) {
  ...
  **/
  ...
  public LSWGetEthPortDto loopbackDetectVlans(String loopbackDetectVlans) {
  ...
  **/
  ...
  public LSWGetEthPortDto isSupportAutoNegotiation(Boolean isSupportAutoNegotiation) {
    this.isSupportAutoNegotiation = isSupportAutoNegotiation;
    return this;
  }

   /**
   * 端口是否支持关闭自协商（只读），根据款型确定是否支持。
   * return isSupportAutoNegotiation
  **/
  @ApiModelProperty(value = "端口是否支持关闭自协商（只读），根据款型确定是否支持。")
  public Boolean getIsSupportAutoNegotiation() {
    return isSupportAutoNegotiation;
  }

   /**
   * 端口是否支持关闭自协商（只读），根据款型确定是否支持。
   * Param isSupportAutoNegotiation
  **/
  public void setIsSupportAutoNegotiation(Boolean isSupportAutoNegotiation) {
    this.isSupportAutoNegotiation = isSupportAutoNegotiation;
  }

  public LSWGetEthPortDto isSupportPoe(Boolean isSupportPoe) {
   ...
   * return isSupportPoe
  **/
  @ApiModelProperty(value = "端口是否支持POE使能（只读）。")
  public Boolean getIsSupportPoe() {
    return isSupportPoe;
  }
   ...
   * Param isSupportPoe
  **/
  public void setIsSupportPoe(Boolean isSupportPoe) {
    this.isSupportPoe = isSupportPoe;
  }

  public LSWGetEthPortDto media(String media) {
    this.media = media;
    return this;
  }

   /**
   * 端口模式（只读）。fiber：光口模式；copper：电口模式。
   * return media
  **/
  @ApiModelProperty(value = "端口模式（只读）。fiber：光口模式；copper：电口模式。")
  ...
  **/
  ...
  public LSWGetEthPortDto isUpStream(Boolean isUpStream) {
   ...
   * return isUpStream
  **/
  @ApiModelProperty(value = "端口是否为上行口（只读）。")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LSWGetEthPortDto lsWGetEthPortDto = (LSWGetEthPortDto) o;
    return Objects.equals(this.status, lsWGetEthPortDto.status) &&
        Objects.equals(this.description, lsWGetEthPortDto.description) &&
        Objects.equals(this.linkType, lsWGetEthPortDto.linkType) &&
        Objects.equals(this.defaultVlan, lsWGetEthPortDto.defaultVlan) &&
        Objects.equals(this.allowPassVlan, lsWGetEthPortDto.allowPassVlan) &&
        Objects.equals(this.dhcpSnooping, lsWGetEthPortDto.dhcpSnooping) &&
        Objects.equals(this.dhcpSnoopingTrusted, lsWGetEthPortDto.dhcpSnoopingTrusted) &&
        Objects.equals(this.ndSnooping, lsWGetEthPortDto.ndSnooping) &&
        Objects.equals(this.ndSnoopingTrusted, lsWGetEthPortDto.ndSnoopingTrusted) &&
        Objects.equals(this.portIsolation, lsWGetEthPortDto.portIsolation) &&
        Objects.equals(this.stp, lsWGetEthPortDto.stp) &&
        Objects.equals(this.stpEdgedport, lsWGetEthPortDto.stpEdgedport) &&
        Objects.equals(this.enableRelay, lsWGetEthPortDto.enableRelay) &&
        Objects.equals(this.enableMadDetection, lsWGetEthPortDto.enableMadDetection) &&
        Objects.equals(this.domainId, lsWGetEthPortDto.domainId) &&
        Objects.equals(this.naMsgCheck, lsWGetEthPortDto.naMsgCheck) &&
        Objects.equals(this.nsMsgCheck, lsWGetEthPortDto.nsMsgCheck) &&
        Objects.equals(this.rsMsgCheck, lsWGetEthPortDto.rsMsgCheck) &&
        Objects.equals(this.ipsgCheck, lsWGetEthPortDto.ipsgCheck) &&
        Objects.equals(this.daiCheck, lsWGetEthPortDto.daiCheck) &&
        Objects.equals(this.ipSubnetVlanEnable, lsWGetEthPortDto.ipSubnetVlanEnable) &&
        Objects.equals(this.name, lsWGetEthPortDto.name) &&
        Objects.equals(this.autoNegotiationEnable, lsWGetEthPortDto.autoNegotiationEnable) &&
        Objects.equals(this.speed, lsWGetEthPortDto.speed) &&
        Objects.equals(this.duplex, lsWGetEthPortDto.duplex) &&
        Objects.equals(this.stormControl, lsWGetEthPortDto.stormControl) &&
        Objects.equals(this.stormControlModel, lsWGetEthPortDto.stormControlModel) &&
        Objects.equals(this.stormControlMaxRate, lsWGetEthPortDto.stormControlMaxRate) &&
        Objects.equals(this.stormControlMinRate, lsWGetEthPortDto.stormControlMinRate) &&
        Objects.equals(this.stormControlInterval, lsWGetEthPortDto.stormControlInterval) &&
        Objects.equals(this.poe, lsWGetEthPortDto.poe) &&
        Objects.equals(this.lldp, lsWGetEthPortDto.lldp) &&
        Objects.equals(this.cdp, lsWGetEthPortDto.cdp) &&
        Objects.equals(this.loopbackDetectEnabled, lsWGetEthPortDto.loopbackDetectEnabled) &&
        Objects.equals(this.loopbackDetectAction, lsWGetEthPortDto.loopbackDetectAction) &&
        Objects.equals(this.loopbackDetectVlans, lsWGetEthPortDto.loopbackDetectVlans) &&
        Objects.equals(this.isSupportAutoNegotiation, lsWGetEthPortDto.isSupportAutoNegotiation) &&
        Objects.equals(this.isSupportPoe, lsWGetEthPortDto.isSupportPoe) &&
        Objects.equals(this.media, lsWGetEthPortDto.media) &&
        Objects.equals(this.isUpStream, lsWGetEthPortDto.isUpStream);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, description, linkType, defaultVlan, allowPassVlan, dhcpSnooping, dhcpSnoopingTrusted, ndSnooping, ndSnoopingTrusted, portIsolation, stp, stpEdgedport, enableRelay, enableMadDetection, domainId, naMsgCheck, nsMsgCheck, rsMsgCheck, ipsgCheck, daiCheck, ipSubnetVlanEnable, name, autoNegotiationEnable, speed, duplex, stormControl, stormControlModel, stormControlMaxRate, stormControlMinRate, stormControlInterval, poe, lldp, cdp, loopbackDetectEnabled, loopbackDetectAction, loopbackDetectVlans, isSupportAutoNegotiation, isSupportPoe, media, isUpStream);
  }
  ...
  public String toString() {
    ...
    sb.append("class LSWGetEthPortDto {\n");
    ...
    sb.append("    isSupportAutoNegotiation: ").append(toIndentedString(isSupportAutoNegotiation)).append("\n");
    sb.append("    isSupportPoe: ").append(toIndentedString(isSupportPoe)).append("\n");
