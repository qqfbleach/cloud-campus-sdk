...
public class LSWEthTrunkPortRespDto {
  ...
  public LSWEthTrunkPortRespDto status(Boolean status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto description(String description) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto linkType(String linkType) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto defaultVlan(Integer defaultVlan) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto allowPassVlan(String allowPassVlan) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto dhcpSnooping(Boolean dhcpSnooping) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto dhcpSnoopingTrusted(Boolean dhcpSnoopingTrusted) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto ndSnooping(Boolean ndSnooping) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto ndSnoopingTrusted(Boolean ndSnoopingTrusted) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto portIsolation(Boolean portIsolation) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto stp(Boolean stp) {
    this.stp = stp;
    return this;
  }
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto stpEdgedport(String stpEdgedport) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto enableRelay(Boolean enableRelay) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto enableMadDetection(Boolean enableMadDetection) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto domainId(Integer domainId) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto naMsgCheck(Boolean naMsgCheck) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto nsMsgCheck(Boolean nsMsgCheck) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto rsMsgCheck(Boolean rsMsgCheck) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto ipsgCheck(Boolean ipsgCheck) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto daiCheck(Boolean daiCheck) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto ipSubnetVlanEnable(Boolean ipSubnetVlanEnable) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto ethTrunkMode(String ethTrunkMode) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto portMemberList(List<String> portMemberList) {
    this.portMemberList = portMemberList;
    return this;
  }

  public LSWEthTrunkPortRespDto addPortMemberListItem(String portMemberListItem) {
  ...
  **/
  ...
  public LSWEthTrunkPortRespDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LSWEthTrunkPortRespDto lsWEthTrunkPortRespDto = (LSWEthTrunkPortRespDto) o;
    return Objects.equals(this.status, lsWEthTrunkPortRespDto.status) &&
        Objects.equals(this.description, lsWEthTrunkPortRespDto.description) &&
        Objects.equals(this.linkType, lsWEthTrunkPortRespDto.linkType) &&
        Objects.equals(this.defaultVlan, lsWEthTrunkPortRespDto.defaultVlan) &&
        Objects.equals(this.allowPassVlan, lsWEthTrunkPortRespDto.allowPassVlan) &&
        Objects.equals(this.dhcpSnooping, lsWEthTrunkPortRespDto.dhcpSnooping) &&
        Objects.equals(this.dhcpSnoopingTrusted, lsWEthTrunkPortRespDto.dhcpSnoopingTrusted) &&
        Objects.equals(this.ndSnooping, lsWEthTrunkPortRespDto.ndSnooping) &&
        Objects.equals(this.ndSnoopingTrusted, lsWEthTrunkPortRespDto.ndSnoopingTrusted) &&
        Objects.equals(this.portIsolation, lsWEthTrunkPortRespDto.portIsolation) &&
        Objects.equals(this.stp, lsWEthTrunkPortRespDto.stp) &&
        Objects.equals(this.stpEdgedport, lsWEthTrunkPortRespDto.stpEdgedport) &&
        Objects.equals(this.enableRelay, lsWEthTrunkPortRespDto.enableRelay) &&
        Objects.equals(this.enableMadDetection, lsWEthTrunkPortRespDto.enableMadDetection) &&
        Objects.equals(this.domainId, lsWEthTrunkPortRespDto.domainId) &&
        Objects.equals(this.naMsgCheck, lsWEthTrunkPortRespDto.naMsgCheck) &&
        Objects.equals(this.nsMsgCheck, lsWEthTrunkPortRespDto.nsMsgCheck) &&
        Objects.equals(this.rsMsgCheck, lsWEthTrunkPortRespDto.rsMsgCheck) &&
        Objects.equals(this.ipsgCheck, lsWEthTrunkPortRespDto.ipsgCheck) &&
        Objects.equals(this.daiCheck, lsWEthTrunkPortRespDto.daiCheck) &&
        Objects.equals(this.ipSubnetVlanEnable, lsWEthTrunkPortRespDto.ipSubnetVlanEnable) &&
        Objects.equals(this.ethTrunkMode, lsWEthTrunkPortRespDto.ethTrunkMode) &&
        Objects.equals(this.portMemberList, lsWEthTrunkPortRespDto.portMemberList) &&
        Objects.equals(this.name, lsWEthTrunkPortRespDto.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, description, linkType, defaultVlan, allowPassVlan, dhcpSnooping, dhcpSnoopingTrusted, ndSnooping, ndSnoopingTrusted, portIsolation, stp, stpEdgedport, enableRelay, enableMadDetection, domainId, naMsgCheck, nsMsgCheck, rsMsgCheck, ipsgCheck, daiCheck, ipSubnetVlanEnable, ethTrunkMode, portMemberList, name);
  }
  ...
  public String toString() {
    ...
    sb.append("class LSWEthTrunkPortRespDto {\n");
