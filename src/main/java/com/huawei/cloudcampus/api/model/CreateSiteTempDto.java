...
public class CreateSiteTempDto {
  @SerializedName("name")
  ...
  public CreateSiteTempDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public CreateSiteTempDto types(List<String> types) {
    this.types = types;
    return this;
  }

  public CreateSiteTempDto addTypesItem(String typesItem) {
   ...
   * return types
  **/
  @ApiModelProperty(required = true, value = "站点模板类型列表，可为AP，LSW，FW。")
  ...
  **/
  ...
  public CreateSiteTempDto custom(Boolean custom) {
    this.custom = custom;
    return this;
  }
  ...
  **/
  ...
  public CreateSiteTempDto configIdentifies(List<ConfigIdentifiesEnum> configIdentifies) {
    this.configIdentifies = configIdentifies;
    return this;
  }

  public CreateSiteTempDto addConfigIdentifiesItem(ConfigIdentifiesEnum configIdentifiesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateSiteTempDto createSiteTempDto = (CreateSiteTempDto) o;
    return Objects.equals(this.name, createSiteTempDto.name) &&
        Objects.equals(this.types, createSiteTempDto.types) &&
        Objects.equals(this.custom, createSiteTempDto.custom) &&
        Objects.equals(this.configIdentifies, createSiteTempDto.configIdentifies);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSiteTempDto {\n");
