...
public class AclDtoInResponse {
  ...
  public AclDtoInResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public AclDtoInResponse aclNumber(String aclNumber) {
  ...
  **/
  ...
  public AclDtoInResponse description(String description) {
  ...
  **/
  ...
  public AclDtoInResponse aclType(AclTypeEnum aclType) {
  ...
  **/
  ...
  public AclDtoInResponse ruleList(List<RuleList> ruleList) {
    this.ruleList = ruleList;
    return this;
  }

  public AclDtoInResponse addRuleListItem(RuleList ruleListItem) {
  ...
  **/
  ...
  public AclDtoInResponse id(String id) {
    this.id = id;
    return this;
  }
   ...
   * return id
  **/
  @ApiModelProperty(required = true, value = "ACL模板标识，UUID格式。")
  public String getId() {
    return id;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AclDtoInResponse aclDtoInResponse = (AclDtoInResponse) o;
    return Objects.equals(this.name, aclDtoInResponse.name) &&
        Objects.equals(this.aclNumber, aclDtoInResponse.aclNumber) &&
        Objects.equals(this.description, aclDtoInResponse.description) &&
        Objects.equals(this.aclType, aclDtoInResponse.aclType) &&
        Objects.equals(this.ruleList, aclDtoInResponse.ruleList) &&
        Objects.equals(this.id, aclDtoInResponse.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, aclNumber, description, aclType, ruleList, id);
  }
  ...
  public String toString() {
    ...
    sb.append("class AclDtoInResponse {\n");
