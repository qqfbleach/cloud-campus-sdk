...
import com.huawei.cloudcampus.api.sample.APIConstants;
import com.huawei.cloudcampus.api.sample.ClientSample;
import com.huawei.cloudcampus.api.sample.GetTokenIdRequest;
import com.huawei.cloudcampus.api.sample.GetTokenIdResponse;
import com.huawei.cloudcampus.api.sample.HttpMethodEnum;
import com.huawei.cloudcampus.api.sample.JacksonSerialized;
import com.huawei.cloudcampus.api.sample.PropsUtil;
import com.huawei.cloudcampus.api.sample.RestfulApiInvoker;
...
import com.huawei.cloudcampus.api.auth.Authentication;
import com.huawei.cloudcampus.api.auth.HttpBasicAuth;
import com.huawei.cloudcampus.api.auth.ApiKeyAuth;
import com.huawei.cloudcampus.api.auth.OAuth;
...
public class ApiClient {
    ...
    private String host = PropsUtil.getPropByKey(APIConstants.CAMPUS_ADDRESS);
    private String port = PropsUtil.getPropByKey(APIConstants.CAMPUS_PORT);
    private String tenantName = PropsUtil.getPropByKey(APIConstants.CAMPUS_USERNAME);
    private String tenantPwd = PropsUtil.getPropByKey(APIConstants.CAMPUS_PASSWORD);
    private String basePath = "https://" + host + (com.huawei.cloudcampus.api.sample.StringUtil.isNullOrEmpty(port) ? "" : (":" + port));
    ...
    public ApiClient(String host, String port, String tenantName, String tenantPwd) {
    ...
    public ApiClient() {
        ...
        setUserAgent("PostmanRuntime/6.4.1");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://localhost/secm/public/services/fwaas/v1/threatdefense
    ...
    public Call buildCall(String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String[] authNames, ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // String tokenId = ClientSample.getTokenId();
        headerParams.put("x-access-token", tokenId);
    ...
    private String getTokenId() {
        GetTokenIdRequest getTokenIdRequest = new GetTokenIdRequest();
        // 默认的租户名、租户密码
        getTokenIdRequest.setUserName(PropsUtil.getPropByKey(APIConstants.CAMPUS_USERNAME));
        getTokenIdRequest.setPassword(PropsUtil.getPropByKey(APIConstants.CAMPUS_PASSWORD));
        // 用户设置的租户名、租户密码
        if (com.huawei.cloudcampus.api.sample.StringUtil.isNotNullOrEmpty(this.tenantName)) {
            getTokenIdRequest.setUserName(this.tenantName);
        }
        if (com.huawei.cloudcampus.api.sample.StringUtil.isNotNullOrEmpty(this.tenantPwd)) {
            getTokenIdRequest.setPassword(this.tenantPwd);
        }

        // 默认的IP、端口
        String host = PropsUtil.getPropByKey(APIConstants.CAMPUS_ADDRESS);
        String port = PropsUtil.getPropByKey(APIConstants.CAMPUS_PORT);
        // 用户设置的IP、端口
        if (com.huawei.cloudcampus.api.sample.StringUtil.isNotNullOrEmpty(this.host)) {
            host = this.host;
        }
        if (com.huawei.cloudcampus.api.sample.StringUtil.isNotNullOrEmpty(this.port)) {
            port = this.port;
        }
        // String host = com.huawei.cloudcampus.api.sample.StringUtil.isNotNullOrEmpty(this.host) ? this.host : PropsUtil.getPropByKey(APIConstants.CAMPUS_ADDRESS);
        // String port = com.huawei.cloudcampus.api.sample.StringUtil.isNotNullOrEmpty(this.port) ? this.port : PropsUtil.getPropByKey(APIConstants.CAMPUS_PORT);
        String tokenUrl = "https://" + host + (com.huawei.cloudcampus.api.sample.StringUtil.isNullOrEmpty(port) ? "" : (":" + port)) + POST_TOKEN_URL;
        String json = RestfulApiInvoker.invoke(getTokenIdRequest, tokenUrl, HttpMethodEnum.POST);
        ...
        if (response == null || response.getData() == null) {
            ...
            tokenId = response.getData().getToken_id();
        }
        return tokenId;
    }
    ...
    public void setHost(String host) {
        this.host = host;
        this.basePath = "https://" + this.host + (com.huawei.cloudcampus.api.sample.StringUtil.isNullOrEmpty(this.port) ? "" : (":" + this.port));
    }
